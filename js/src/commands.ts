...
export function addPageLoadSite(site: Site, app: JupyterFrontEnd) {
  app.restored.then(() => {
    const { path } = site;
...
export function addLauncherSite(
  site: Site,
  app: JupyterFrontEnd,
  launcher: ILauncher,
) {
