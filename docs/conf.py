...
# -*- coding: utf-8 -*-
#
# jupyterlab_iframe documentation build configuration file, created by
...
htmlhelp_basename = 'jupyterlab_iframedoc'
...
latex_documents = [
    (master_doc, 'jupyterlab_iframe.tex', 'jupyterlab_iframe Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'jupyterlab_iframe', 'jupyterlab_iframe Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jupyterlab_iframe', 'jupyterlab_iframe Documentation',
     author, 'jupyterlab_iframe', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    jupyterlab_iframe_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'jupyterlab_iframe'))
