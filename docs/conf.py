...
latex_documents = [
    (
        master_doc,
        "jupyterlab_iframe.tex",
        "jupyterlab_iframe Documentation",
        "Tim Paine",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "jupyterlab_iframe", "jupyterlab_iframe Documentation", [author], 1)
]
...
def run_apidoc(_):
    ...
    jupyterlab_iframe_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "..", "jupyterlab_iframe")
    )
    ...
    subprocess.check_call(
        [cmd_path, "-E", "-M", "-o", out_dir, jupyterlab_iframe_dir, "--force"]
    )
